      ...
      try
                {
                    ...
                    try
                    {
                        String qry = "select * from orders_table";
                        ...
                        if(rst.next())
                        {
                           do
                           {
                               ...
                               out.print("<select class='form-select' name='stat' onchange='changestatus(" + e + ", this.value)'>");
                               out.print("<option value='Pending' "   + (currentStatus.equals("Pending")   ? "selected" : "") + ">Pending</option>");
                               out.print("<option value='Shipped' "   + (currentStatus.equals("Shipped")   ? "selected" : "") + ">Shipped</option>");
                               out.print("<option value='Delivered' " + (currentStatus.equals("Delivered") ? "selected" : "") + ">Delivered</option>");
                               out.print("</select>");
        ...
        <script>
            ...
            {
                fetch("statuschange.jsp?idd="+orderid+"&stat="+status)
